...
/**
 * Runtime transient data container for the ArangoDB foxx invoke Step
 * 
 * @author Adam Fowler {@literal <adam.fowler@hitachivantara.com>}
 * @since 1.0 2018-03-08
 */
public class ArangoDBFoxxInvokeData extends BaseStepData implements StepDataInterface {
