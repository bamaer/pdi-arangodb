...
/**
 * Runtime transient data container for the ArangoDB Document Output Step
 * 
 * @author Adam Fowler {@literal <adam.fowler@hitachivantara.com>}
 * @since 1.0 2018-03-06
 */
public class ArangoDBDocumentOutputData extends BaseStepData implements StepDataInterface {
   ...
   * Default constructor
   */
  public ArangoDBDocumentOutputData() {
    super();
  }
