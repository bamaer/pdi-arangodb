...
@Step(id = "ArangoDBFoxxInvoke", image = "logo-ArangoDB-Foxx.png", i18nPackageName = "org.pentaho.kettle.steps.arangodb.foxxinvoke", name = "ArangoDBFoxxInvoke.Name", description = "ArangoDBFoxxInvoke.Description", categoryDescription = "BaseStep.Category.BigData")
/**
 * Metadata (configuration) holding class for the ArangoDB foxx invoke step
 * 
 * @author Adam Fowler {@literal <adam.fowler@hitachivantara.com>}
 * @since 1.0 2018-03-08
 */
public class ArangoDBFoxxInvokeMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private String serviceField = null;
   ...
   */
  public Object clone() {
    ArangoDBFoxxInvokeMeta retval = (ArangoDBFoxxInvokeMeta) super.clone();
    return retval;
  }
  ...
  private void readData(Node entrynode, List<? extends SharedObjectInterface> databases) throws KettleXMLException {
    try {
      ...
      serviceField = XMLHandler.getTagValue(entrynode, "serviceField");
      documentContentField = XMLHandler.getTagValue(entrynode, "documentContentField");
    } catch (Exception e) {
      throw new KettleXMLException(
          BaseMessages.getString(PKG, "ArangoDBFoxxInvokeMeta.Exception.UnableToLoadStepInfo"), e);
    }
  }
  ...
  public String getXML() {
    ...
    retval.append("      ").append(XMLHandler.addTagValue("serviceField", serviceField));
  ...
  public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
    ...
    try {
      ...
      serviceField = rep.getJobEntryAttributeString(id_step, "serviceField");
      documentContentField = rep.getJobEntryAttributeString(id_step, "documentContentField");
    } catch (Exception e) {
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBFoxxInvokeMeta.Exception.UnexpectedErrorWhileReadingStepInfo"), e);
    }
  ...
  public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
    ...
    try {
      ...
      rep.saveJobEntryAttribute(id_transformation, getObjectId(), "serviceField", serviceField);
      rep.saveJobEntryAttribute(id_transformation, getObjectId(), "documentContentField", documentContentField);
    } catch (KettleException e) {
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBFoxxInvokeMeta.Exception.UnableToSaveStepInfo") + id_step, e);
    }
  }
  ...
  public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if (input.length > 0) {
      cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
          BaseMessages.getString(PKG, "ArangoDBFoxxInvokeMeta.CheckResult.StepReceiveInfo.DialogMessage"), stepMeta);
      remarks.add(cr);
    } else {
      cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
          BaseMessages.getString(PKG, "ArangoDBFoxxInvokeMeta.CheckResult.NoInputReceived.DialogMessage"), stepMeta);
      remarks.add(cr);
    }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans trans) {
    return new ArangoDBFoxxInvoke(stepMeta, stepDataInterface, cnr, transMeta, trans);
  }
  ...
  public StepDataInterface getStepData() {
    return new ArangoDBFoxxInvokeData();
  }
...
/*
  ...
  public void setServiceField(String sf) {
    serviceField = sf;
  }
