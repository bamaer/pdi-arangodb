...
@Step(id = "ArangoDBCollectionScanInput", image = "ArangoDB-scan-input.png", i18nPackageName = "org.pentaho.kettle.steps.arangodb.collectionscaninput", name = "ArangoDBCollectionScanInput.Name", description = "ArangoDBCollectionScanInput.Description", categoryDescription = "BaseStep.Category.BigData")
/**
 * Metadata (configuration) holding class for the ArangoDB collection scan input step
 * 
 * @author Adam Fowler {@literal <adam.fowler@hitachivantara.com>}
 * @since 1.0 2018-03-07
 */
public class ArangoDBCollectionScanInputMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   */
  public Object clone() {
    ArangoDBCollectionScanInputMeta retval = (ArangoDBCollectionScanInputMeta) super.clone();
    return retval;
  }
  ...
  private void readData(Node entrynode, List<? extends SharedObjectInterface> databases) throws KettleXMLException {
    try {
      ...
      throw new KettleXMLException(
          BaseMessages.getString(PKG, "ArangoDBCollectionScanInputMeta.Exception.UnableToLoadStepInfo"), e);
    }
  }
  ...
  public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
    ...
    try {
      ...
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBCollectionScanInputMeta.Exception.UnexpectedErrorWhileReadingStepInfo"), e);
    }
  ...
  public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
    ...
    try {
      ...
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBCollectionScanInputMeta.Exception.UnableToSaveStepInfo") + id_step, e);
    }
  }
  ...
  public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if (input.length > 0) {
      cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
          BaseMessages.getString(PKG, "ArangoDBCollectionScanInputMeta.CheckResult.StepReceiveInfo.DialogMessage"), stepMeta);
      remarks.add(cr);
    } else {
      cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
          BaseMessages.getString(PKG, "ArangoDBCollectionScanInputMeta.CheckResult.NoInputReceived.DialogMessage"), stepMeta);
      remarks.add(cr);
    }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans trans) {
    return new ArangoDBCollectionScanInput(stepMeta, stepDataInterface, cnr, transMeta, trans);
  }
  ...
  public StepDataInterface getStepData() {
    return new ArangoDBCollectionScanInputData();
  }
