...
@Step(id = "ArangoDBDocumentInput", image = "ArangoDB-input.png", i18nPackageName = "org.pentaho.kettle.steps.arangodb.documentinput", name = "ArangoDBDocumentInput.Name", description = "ArangoDBDocumentInput.Description", categoryDescription = "BaseStep.Category.BigData")
/**
 ...
 */
public class ArangoDBDocumentInputMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   */
  public Object clone() {
    ArangoDBDocumentInputMeta retval = (ArangoDBDocumentInputMeta) super.clone();
    return retval;
  }
  ...
  private void readData(Node entrynode, List<? extends SharedObjectInterface> databases) throws KettleXMLException {
    try {
      ...
      throw new KettleXMLException(BaseMessages.getString(PKG, "ArangoDBDocumentInputMeta.Exception.UnableToLoadStepInfo"), e);
    }
  }
  ...
  public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
    ...
    try {
      ...
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBDocumentInputMeta.Exception.UnexpectedErrorWhileReadingStepInfo"), e);
    }
  ...
  public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
    ...
    try {
      ...
      throw new KettleException(
          BaseMessages.getString(PKG, "ArangoDBDocumentInputMeta.Exception.UnableToSaveStepInfo") + id_step, e);
    }
  }
  ...
  public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if (input.length > 0) {
      cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
          BaseMessages.getString(PKG, "ArangoDBDocumentInputMeta.CheckResult.StepReceiveInfo.DialogMessage"), stepMeta);
      remarks.add(cr);
    } else {
      cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
          BaseMessages.getString(PKG, "ArangoDBDocumentInputMeta.CheckResult.NoInputReceived.DialogMessage"), stepMeta);
      remarks.add(cr);
    }
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans trans) {
    return new ArangoDBDocumentInput(stepMeta, stepDataInterface, cnr, transMeta, trans);
  }
  ...
  public StepDataInterface getStepData() {
    return new ArangoDBDocumentInputData();
  }
